...
public class ORestPlzSatRiesgosS {
  ...
  @ApiModelProperty(value = "Capital reasegurado, coincidirá con el de referencia menos el porcentaje cedido en coaseguro.")
  private BigDecimal impCapRea = null;

  @ApiModelProperty(value = "Importe de la suma máxima expuesta del capital del reaseguro.")
  private BigDecimal impSumaMaxExpuesta = null;

  @ApiModelProperty(value = "Marca que indica si es el tercero principal. Posibles valores [S - PRINCIPAL, N - NO PRINCIPAL]")
  private String mcaPrincipal = null;

  @ApiModelProperty(value = "Marca que indica si está tarificado. Posibles valores [S - TARIFICADO, N - NO TARIFICADO]")
  private String mcaTarificado = null;
