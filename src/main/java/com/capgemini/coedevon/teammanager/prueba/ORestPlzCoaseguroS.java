...
public class ORestPlzCoaseguroS {
  ...
  @ApiModelProperty(value = "Marca de inhabilitacion del registro. Esta marca se utilizará para indicar si se solicita recuperar las ocurrencias habilitadas, inhabilitadas o todas: - valor N: Registros habilitados - valor S: Registros inhabilitados - valor A: Ambos. Si se envía vacío, el valor por defecto es A. Valor A por defecto.")
  private String mcaInh = "A";

  @ApiModelProperty(value = "Descripción de la cia coaseguradora")
  private String nomCiaCoa = null;

  @ApiModelProperty(value = "Descripción del cuadro")
  ...
  @ApiModelProperty(value = "Porcentaje de comision de la coaseguradora 1")
  private BigDecimal pctComCoa1 = null;

  @ApiModelProperty(value = "Porcentaje de comision de la coaseguradora 2")
  private BigDecimal pctComCoa2 = null;

  @ApiModelProperty(value = "Porcentaje de comision de la coaseguradora 3")
  private BigDecimal pctComCoa3 = null;

  @ApiModelProperty(value = "Porcentaje de comision de la coaseguradora 4")
