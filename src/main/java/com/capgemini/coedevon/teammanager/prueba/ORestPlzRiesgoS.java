...
public class ORestPlzRiesgoS {
  ...
  @ApiModelProperty(value = "Descripcion del codigo clave ioas")
  private String nomCodIoas = null;
  ...
  @ApiModelProperty(value = "Descripcion del tipo de modalidad del riesgo")
  private String nomTipModRiesgo = null;

  @ApiModelProperty(value = "Descripcion del tipo de suplemento. Posibles valores en la tabla [[TRON.TPES.TIP_SPTO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
