...
public class TipEmiRecibo {
  @ApiModelProperty(required = true, value = "Tipo de remesa. Posibles valores en la tabla [[TRON.TPES.TIP_EMI_RECIBO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
