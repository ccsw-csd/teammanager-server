...
public class OGnrMensajeAdvertS {
  @ApiModelProperty(required = true, value = "Código de advertencia")
  private Integer codAdvert = null;

  @ApiModelProperty(value = "Descripción de advertencia")
  private String txtAdvert = null;
