...
public class ORestGcPolizaS {
  ...
  @ApiModelProperty(value = "Descripción asociada al codigo de la forma de pago/plan de pago. Posibles valores en la tabla [[TRON.EMIS.PLANES_PAGO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomPlanPago = null;

  @ApiModelProperty(value = "Descripción asociada al codigo del ramo. Posibles valores en la tabla [[TRON.EMIS.RAMOS]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  ...
  @ApiModelProperty(value = "Descripción del tipo de situación de la póliza. Posibles valores en la tabla [[TRON.TPES.TIP_SITU_POLIZA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomSituPoliza = null;

  @ApiModelProperty(value = "Descripción del tercero agente")
  private String nomTerceroAgt = null;

  @ApiModelProperty(value = "descripción asociada al tipo de negocio. Posibles valores en la tabla [[TRON.CSTR.COD_TIP_NEGOCIO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipNegocio = null;

  @ApiModelProperty(value = "Descripción asociada al tipo de reaseguro. Posibles valores en la tabla [[TRON.TPES.TIP_REA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
