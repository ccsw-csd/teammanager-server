...
public class ORestPlzOcurrenciaS {
  ...
  @ApiModelProperty(value = "Descripcion del codigo de lista. Posibles valores en la tabla [[TRON.TPES.TIP_LISTA_OCU]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipListaOcu = null;
