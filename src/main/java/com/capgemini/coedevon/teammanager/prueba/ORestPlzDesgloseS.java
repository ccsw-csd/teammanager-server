...
public class ORestPlzDesgloseS {
  ...
  @ApiModelProperty(value = "Nombre del concepto de desglose. Posibles valores en la tabla [[TRON.EMIS.CONCEPTOS_DESGLOSE_CIA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomDes = null;

  @ApiModelProperty(value = "Descripcion del concepto economico")
  private String nomEco = null;

  @ApiModelProperty(value = "denominacion de la moneda. Posibles valores en la tabla [[TRON.DATC.MONEDAS]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomMon = null;

  @ApiModelProperty(value = "Descripcion de la forma de pago/plan de pago. Posibles valores en la tabla [[TRON.EMIS.PLANES_PAGO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  ...
  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en el caso de que un suplemento aumente el capital sin modificar la estructura de contratacion (1) tarifa actual (2) tarifa original (3) mixta (4) objeto. Posibles valores en la tabla [[TRON.TPES.TIP_ACCION_AUM_NO_MOD]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipAccionAumNoMod = null;

  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en el caso de que un suplemento aumente el capital y se ha cambiado la estructura de contratacion (1) tarifa actual (4) objeto. Posibles valores en la tabla [[TRON.TPES.TIP_ACCION_AUM_SI_MOD]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipAccionAumSiMod = null;

  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en un suplemento que baja el capital sin modificar la estructura de contratacion (1)tarifa actual (2)tarifa original (4)objeto")
  private String nomTipAccionBajaNoMod = null;

  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en un suplemento que baja el capital y se ha modificado la estructura de contratacion (1)tarifa actual (4) objeto")
  private String nomTipAccionBajaSiMod = null;

  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en el caso de que un suplemento se mantenga el capital vigente sin modificar la estructura de contratacion (2) tarifa original (4) objeto")
  private String nomTipAccionManNoMod = null;

  @ApiModelProperty(value = "Descripcion que indica el tipo de accion que tomara en el caso de que un suplemento se mantenga el capital vigente y modifica la estructura de contratacion (1) tarifa actual (4) objeto")
  private String nomTipAccionManSiMod = null;

  @ApiModelProperty(value = "Descripcion del calculo utilizado. Posibles valores en la tabla [[TRON.TPES.TIP_APLICA_DES]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipAplicaDes = null;

  @ApiModelProperty(value = "Descripcion de la base de calculo. Posibles valores en la tabla [[TRON.TPES.TIP_BASE_CAL]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipBaseCal = null;

  @ApiModelProperty(value = "Descripcion del tipo de calculo. Posibles valores en la tabla [[TRON.TPES.TIP_CAL_DES]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipCalDes = null;

  @ApiModelProperty(value = "Descripcion de si se informa aqui el tipo de prima minima definido para la cobertura (0) sin prima minima (1) importe fijo (2) tabla (3) objeto. Posibles valores en la tabla [[TRON.TPES.TIP_CAL_MIN]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipCalMin = null;

  @ApiModelProperty(value = "Descripcion del tipo de concepto económico sus valores estarán definidos en la g1010031 y son (n) prima neta, (b) bonificación, (r) recargo, (i) impuesto. Posibles valores en la tabla [[TRON.TPES.TIP_COD_ECO]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipCodEco = null;

  @ApiModelProperty(value = "Descripcion del tipo de desglose. Posibles valores en la tabla [[TRON.TPES.TIP_DES]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipDes = null;
