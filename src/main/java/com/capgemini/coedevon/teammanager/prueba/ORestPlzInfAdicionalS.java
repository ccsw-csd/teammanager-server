...
public class ORestPlzInfAdicionalS {
  ...
  @ApiModelProperty(value = "codigo de bonificcion/recargo")
  private Integer codBoniReca = null;
  ...
  @ApiModelProperty(value = "panel donde se mostrara")
  private String codGrpPnl = null;
  ...
  @ApiModelProperty(value = "codigo de instalacion")
  private String codInstalacion = null;
  ...
  @ApiModelProperty(value = "Marca que indica si afecta de alguna forma al riesgo. solo se solicita en datos variables por poliza. no confundir con mca_cal.. Posibles valores [S - AFECTA AL RIESGO, N - NO AFECTA AL RIESGO]")
  private String mcaAfectaRiesgo = null;
  ...
  @ApiModelProperty(value = "Marca que indica si se grabara el dato al rechazar la poliza. Posibles valores [S - SE GRABARA, N - NO SE GRABARA]")
  ...
  @ApiModelProperty(value = "Marca que indica si forma modalidades. Posibles valores [S - FORMA MODALIDADES, N - NO FORMA MODALIDADES]")
  private String mcaModalidad = null;
  ...
  @ApiModelProperty(value = "marca que indica si el dato variable es susceptible de ser traducido o no. Posibles valores [S - TRADUCIBLE, N - NO TRADUCIBLE]")
  ...
  @ApiModelProperty(value = "nombre de bonificacion/recargo")
  private String nomBoniReca = null;
  ...
  @ApiModelProperty(value = "Descripcion del panel donde se mostrara")
  private String nomCodGrpPnl = null;

  @ApiModelProperty(value = "Descripcion del codigo de instalacion")
  private String nomCodInstalacion = null;
  ...
  @ApiModelProperty(value = "Desccripcion que indica para datos variables de transportes si se pediran en las polizas marco aplicacion o ambas. Posibles valores en la tabla [[TRON.TPES.TIP_ACTU_DV]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipActuDv = null;

  @ApiModelProperty(value = "Descripcion del tipo de bonificacion recargo.  Posibles valores en la tabla [[TRON.TPES.TIP_BONI_RECA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String nomTipBoniReca = null;
  ...
  @ApiModelProperty(value = "Descripcion del tipo de modelo (n-normal, e-encriptado, p-personalizado)")
  ...
  @ApiModelProperty(value = "tipo de bonificacion recargo. Posibles valores en la tabla [[TRON.TPES.TIP_BONI_RECA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
  private String tipBoniReca = null;
  ...
  @ApiModelProperty(value = "Marca que indica si la contratacion de la cobertura provoca la necesidad de tener inspeccionado el riesgo. Posibles valores en la tabla [[TRON.TPES.TIP_REVALORIZA]] del activo RAM Catálogo de Tablas de Núcleo [1.0]")
