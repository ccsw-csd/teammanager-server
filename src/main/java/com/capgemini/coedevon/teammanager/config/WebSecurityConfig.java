...
import com.capgemini.coedevon.teammanager.config.security.JsonWebTokenAuthenticationFilter;
import com.capgemini.coedevon.teammanager.config.security.JsonWebTokenAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void setupAuthorization(HttpSecurity http) throws Exception {
        ...
        String[] unsecuredResources = new String[] { "/", "/public/**", "/api/**" };
